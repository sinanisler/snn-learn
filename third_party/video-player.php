...
class SNN_Learn_Video_Player_Element extends Element {
    public $category     = 'snn-learn';
    public $name         = 'snn-learn-video-player';
    public $icon         = 'ti-control-play';
    public $css_selector = '.snn-learn-player-wrapper';
    public $scripts      = [];
    public $nestable     = false;

    public function get_label() {
        return esc_html__( 'SNN Learn Video Player', 'snn-learn' );
    }

    public function set_controls() {
        $this->controls['video_file'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Video File (Media Library)', 'snn-learn' ),
            'type'  => 'video',
            'default' => [
        ...
        $this->controls['video_url_manual'] = [
            'tab'           => 'content',
            'label'         => esc_html__( 'Video URL (Manual)', 'snn-learn' ),
            'type'          => 'text',
            'placeholder' => 'e.g., https://example.com/your-video.mp4 or use {dynamic_tags}',
            'description' => esc_html__( 'Enter a direct URL to your video file or dynamic tag.', 'snn-learn' ),
        ];

        $this->controls['poster_url'] = [
            'tab'           => 'content',
            'label'         => esc_html__( 'Poster Image URL', 'snn-learn' ),
            'type'          => 'text',
            'placeholder' => 'e.g., https://example.com/poster.jpg or use {dynamic_tags}',
            'description' => esc_html__( 'Enter a direct URL to your poster image.', 'snn-learn' ),
        ];

        $this->controls['use_featured_image_as_poster'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Use Featured Image as Poster', 'snn-learn' ),
            'type'  => 'checkbox',
            'default' => false,
            'description' => esc_html__( 'Enable this to automatically use the current post\'s featured image as the video poster.', 'snn-learn' ),
        ];

        $this->controls['enable_subtitle_looping'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Enable Subtitle Looping', 'snn-learn' ),
            'type'  => 'checkbox',
            'default' => false,
            'description' => esc_html__( 'When enabled, subtitles will be automatically loaded from the current post custom fields named "subtitle" or "subtitles". Use the Double Text custom field for this.', 'snn-learn' ),
        ];

        $this->controls['subtitles'] = [
            'tab'           => 'content',
            'label'         => esc_html__( 'Subtitles / Captions', 'snn-learn' ),
            'type'          => 'repeater',
            'titleProperty' => 'label',
            'placeholder'   => esc_html__( 'Subtitle language', 'bricks' ),
            'fields'        => [
                'subtitle_file' => [
                    'label' => esc_html__( 'WebVTT File', 'snn-learn' ),
                    'type'  => 'file',
                    'description' => esc_html__( 'Upload a WebVTT subtitle file (.vtt)', 'snn-learn' ),
                ],
                'label' => [
                    'label' => esc_html__( 'Label', 'snn-learn' ),
                    'type'  => 'text',
                    'placeholder' => esc_html__( 'e.g., English, Spanish, French', 'snn-learn' ),
                    'description' => esc_html__( 'Language name shown to users. If empty, will use the filename.', 'snn-learn' ),
                ],
                'is_default' => [
                    'label' => esc_html__( 'Default', 'snn-learn' ),
                    'type'  => 'checkbox',
                    'default' => false,
                    'description' => esc_html__( 'Set as default subtitle', 'snn-learn' ),
                ],
            ],
        ...
        $this->controls['autoplay'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Autoplay', 'snn-learn' ),
            'type'  => 'checkbox',
            'default' => false,
        ];
        ...
        $this->controls['muted'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Muted', 'snn-learn' ),
            'type'  => 'checkbox',
            'default' => false,
        ];
        ...
        $this->controls['loop'] = [
            'tab' => 'content',
            'label' => esc_html__( 'Loop', 'snn-learn' ),
            'type' => 'checkbox',
            'default' => false,
        ];
        ...
        $this->controls['play_on_viewport'] = [
            'tab'         => 'content',
            'label'       => esc_html__( 'Play on Viewport Entry', 'snn-learn' ),
            'type'        => 'checkbox',
            'default'     => false,
            'description' => esc_html__( 'Automatically play when the player is more than 50% visible in the viewport, and pause when it leaves. Only one video plays at a time.', 'snn-learn' ),
        ];

        $this->controls['disable_autohide'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Disable Auto Hide Controls', 'snn-learn' ),
            'type'  => 'checkbox',
            'default' => false,
        ];
        ...
        $this->controls['enable_chapter_looping'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Enable Chapter Looping', 'snn-learn' ),
            'type'  => 'checkbox',
            'default' => false,
            'description' => esc_html__( 'When enabled, chapters will be automatically loaded from the current post custom fields named "chapter" or "chapters". Use the Double Text custom field for this.', 'snn-learn' ),
        ];

        $this->controls['chapters'] = [
            'tab'           => 'content',
            'label'         => esc_html__( 'Video Chapters', 'snn-learn' ),
            'type'          => 'repeater',
            'titleProperty' => 'title',
            'default'       => [
            ...
            'fields'        => [
                'title' => ['label' => esc_html__( 'Chapter Title', 'snn-learn' ), 'type'  => 'text'],
                'time'  => ['label' => esc_html__( 'Start Time (e.g., 0:00, 1:45)', 'snn-learn' ), 'type' => 'text', 'placeholder' => 'm:ss'],
            ],
        ...
        $this->controls['player_height'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Player Height', 'snn-learn' ),
            'type'  => 'number',
            'units' => ['px', 'vh', 'rem', 'em'],
            'css'   => [
                [
                    'property' => 'height',
                    'selector' => '.snn-learn-video-container',
                ],
            ],
            'default' => '400',
        ];
        ...
        $this->controls['player_max_width'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Player Max Width', 'snn-learn' ),
            'type'  => 'number',
            'units' => ['px', '%', 'rem', 'em', 'vw'],
            'css'   => [
                [
        ...
        $this->controls['video_object_fit'] = [
            'tab'   => 'content',
            'label' => esc_html__( 'Video Object Fit', 'snn-learn' ),
            'type'  => 'select',
            'options' => [
                'contain' => esc_html__( 'Contain (Default)', 'snn-learn' ),
                'cover' => esc_html__( 'Cover', 'snn-learn' ),
                'fill' => esc_html__( 'Fill', 'snn-learn' ),
                'scale-down' => esc_html__( 'Scale Down', 'snn-learn' ),
                'none' => esc_html__( 'None', 'snn-learn' ),
            ],
            'default' => 'contain',
            'description' => esc_html__( 'Controls how the video fits within its container.', 'snn-learn' ),
        ];
        ...
        $this->controls['enable_video_seo_meta'] = [
            'tab'         => 'content',
            'label'       => esc_html__( 'Enable Video SEO Meta Tags', 'snn-learn' ),
            'type'        => 'checkbox',
            'default'     => false,
            'description' => esc_html__( 'Adds VideoObject microdata meta tags to the page <head> to help Google understand your video. Outputs: video name (page title), thumbnailUrl (poster image or featured image), uploadDate (post published date), contentUrl (video file URL), embedUrl (current page URL), and the site language. Enables rich video results in Google Search.', 'snn-learn' ),
        ];
    }
    ...
    public function render() {
        ...
        if ( ! empty( $this->attributes['_root']['id'] ) ) {
            ...
            $root_id = 'snn-learn-player-' . uniqid();
            $this->set_attribute( '_root', 'id', $root_id );
        }

        $this->set_attribute( '_root', 'class', 'brxe-snn-learn-video-player snn-learn-player-wrapper' );
        ...
        echo "<style>
            ...
            #" . esc_attr($root_id) . " .snn-learn-video-container { position: relative; background-color: #000; overflow: hidden; height: var(--player-height); }
            #" . esc_attr($root_id) . " .snn-learn-video-container video { width: 100%; height: 100%; display: block; object-fit: " . esc_attr($video_object_fit) . "; }
            #" . esc_attr($root_id) . " .snn-learn-video-container:fullscreen { width: 100vw; height: 100vh; max-width: 100%; border-radius: 0; }
            ...
            #" . esc_attr($root_id) . " .snn-learn-control-button { background: none; border: none; color: var(--button-color); padding: 5px; border-radius: 9999px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background-color 0.2s; filter:drop-shadow(0px 0px 2px #00000099) }
            #" . esc_attr($root_id) . " .snn-learn-control-button:hover { background-color: var(--button-hover-background); }
            #" . esc_attr($root_id) . " .snn-learn-control-button svg { width: 30px; height: 30px; fill: currentColor; }
            #" . esc_attr($root_id) . " .snn-learn-volume-container { display: flex; align-items: center; position: relative; }
            #" . esc_attr($root_id) . " .snn-learn-volume-container .snn-learn-volume-slider { width: 0; transition: width 0.3s ease; opacity: 0; }
            #" . esc_attr($root_id) . " .snn-learn-volume-container:hover .snn-learn-volume-slider { width: 75px; opacity: 1; }
            ...
            #" . esc_attr($root_id) . " .snn-learn-volume-slider::-webkit-slider-thumb { -webkit-appearance: none; appearance: none; width: 16px; height: 16px; background: var(--thumb-color); border-radius: 50%; cursor: pointer; border: 2px solid var(--primary-accent-color); transition: transform 0.2s ease; }
            #" . esc_attr($root_id) . " .snn-learn-volume-slider:hover::-webkit-slider-thumb { transform: scale(1.1); }
            #" . esc_attr($root_id) . " .snn-learn-volume-slider::-moz-range-thumb { width: 16px; height: 16px; background: var(--thumb-color); border-radius: 50%; cursor: pointer; border: 2px solid var(--primary-accent-color); }
            ...
            #" . esc_attr($root_id) . " .snn-learn-cc-lang-list.snn-learn-hidden { display: none; }
            ...
            #" . esc_attr($root_id) . " .snn-learn-speed-option.snn-learn-active { background-color: var(--primary-accent-color); color: var(--tooltip-text-color); }
            #" . esc_attr($root_id) . " .snn-learn-speed-option svg { width: 16px; height: 16px; fill: currentColor; }
            #" . esc_attr($root_id) . " video::cue { font-size: 20px; }
            #" . esc_attr($root_id) . " .snn-learn-hidden { display: none !important; }
        </style>";

        ?>
        <div class="snn-learn-video-container">
            <video class="snn-learn-video" poster="<?php echo esc_url( $poster_url ); ?>" playsinline crossorigin="anonymous"
            ...
            <div class="snn-learn-controls-overlay">
                <div class="snn-learn-controls-bar-container">
                    <div class="snn-learn-progress-container">
                        <div class="snn-learn-progress-tooltip">00:00</div>
                        <div class="snn-learn-chapter-sections-container"></div>
                        <input type="range" class="snn-learn-video-slider snn-learn-progress-bar" min="0" max="100" step="0.1" value="0">
                        <div class="snn-learn-progress-thumb"></div>
                        <div class="snn-learn-chapter-dots-container"></div>
                    </div>

                    <div class="snn-learn-controls-bar">
                        <div class="snn-learn-controls-left">
                            <button class="snn-learn-control-button snn-learn-play-pause-btn" aria-label="Play/Pause"></button>
                            
                            <div class="snn-learn-volume-container">
                                <button class="snn-learn-control-button snn-learn-mute-btn" aria-label="Mute/Unmute"></button>
                                <input type="range" class="snn-learn-video-slider snn-learn-volume-slider" min="0" max="1" step="0.05" value="1" aria-label="Volume">
                            </div>
                            
                            <div class="snn-learn-time-display">00:00 / 00:00</div>
                        </div>
                        <div class="snn-learn-controls-right">
                            <?php if ( ! empty( $subtitles ) ) : ?>
                            <div class="snn-learn-cc-container">
                                <button class="snn-learn-control-button snn-learn-cc-btn" aria-label="Subtitles">
                                ...
                                <div class="snn-learn-cc-menu">
                                    <button class="snn-learn-cc-back-btn snn-learn-cc-menu-item">
                                    ...
                                    <div class="snn-learn-cc-lang-list">
                                        <button class="snn-learn-cc-menu-item snn-learn-cc-off" data-track="-1">
                                        ...
                                        <button class="snn-learn-cc-menu-item <?php echo $subtitle['is_default'] ? 'snn-learn-active' : ''; ?>" data-track="<?php echo $index; ?>">
                                        ...
                                        <?php endforeach; ?>
                                        <button class="snn-learn-cc-menu-item snn-learn-cc-settings-btn">
                                            <span>Settings</span>
                                    ...
                                    <div class="snn-learn-cc-settings-panel">
                                        <div class="snn-learn-cc-settings-row">
                                            <label class="snn-learn-cc-settings-label">Font Size <span class="snn-learn-cc-settings-label" ><span class="snn-learn-cc-font-size-value">20</span>px</span> </label>
                                            <input type="range" class="snn-learn-cc-settings-input snn-learn-cc-font-size" min="10" max="100" value="20" step="2">
                                            
                                        </div>
                                        <div class="snn-learn-cc-settings-row">
                                            <label class="snn-learn-cc-settings-label">Text Color</label>
                                            <input type="color" class="snn-learn-cc-settings-input snn-learn-cc-text-color" value="#ffffff">
                                        </div>
                                        <div class="snn-learn-cc-settings-row">
                                            <label class="snn-learn-cc-settings-label">Background Color</label>
                                            <input type="color" class="snn-learn-cc-settings-input snn-learn-cc-bg-color" value="#000000">
                                        </div>
                                        <div class="snn-learn-cc-settings-row">
                                            <label class="snn-learn-cc-settings-label">Background Opacity</label>
                                            <input type="range" class="snn-learn-cc-settings-input snn-learn-cc-bg-opacity" min="0" max="100" value="80" step="5">
                                            <span class="snn-learn-cc-settings-label" style="text-align: center; margin-top: 4px;"><span class="snn-learn-cc-bg-opacity-value">80</span>%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                            <div class="snn-learn-settings-container">
                                <button class="snn-learn-control-button snn-learn-settings-btn" aria-label="Playback Speed">1x</button>
                                <div class="snn-learn-settings-menu">
                                    <button class="snn-learn-speed-option snn-learn-active" data-speed="1">1x</button>
                                    <button class="snn-learn-speed-option" data-speed="1.5">1.5x</button>
                                    <button class="snn-learn-speed-option" data-speed="2">2x</button>
                                    <button class="snn-learn-speed-option" data-speed="4">4x</button>
                                    <button class="snn-learn-speed-option" data-speed="8">8x</button>
                                </div>
                            </div>
                            <button class="snn-learn-control-button snn-learn-fullscreen-btn" aria-label="Fullscreen">
                                <svg class="snn-learn-fullscreen-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"></path></svg>
                                <svg class="snn-learn-fullscreen-exit-icon snn-learn-hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"></path></svg>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        (() => {
            ...
            if (!playerWrapper || playerWrapper.dataset.snnLearnPlayerInitialized) {
                return;
            }
            playerWrapper.dataset.snnLearnPlayerInitialized = 'true';
            ...
            const videoContainer          = playerWrapper.querySelector('.snn-learn-video-container');
            const video                   = playerWrapper.querySelector('.snn-learn-video');
            const controlsOverlay         = playerWrapper.querySelector('.snn-learn-controls-overlay');
            const controlsBarContainer = playerWrapper.querySelector('.snn-learn-controls-bar-container');
            const playPauseBtn            = playerWrapper.querySelector('.snn-learn-play-pause-btn');
            const muteBtn                 = playerWrapper.querySelector('.snn-learn-mute-btn');
            const volumeSlider            = playerWrapper.querySelector('.snn-learn-volume-slider');
            const fullscreenBtn           = playerWrapper.querySelector('.snn-learn-fullscreen-btn');
            const progressBar             = playerWrapper.querySelector('.snn-learn-progress-bar');
            const progressThumb           = playerWrapper.querySelector('.snn-learn-progress-thumb');
            const timeDisplay             = playerWrapper.querySelector('.snn-learn-time-display');
            const chapterDotsContainer = playerWrapper.querySelector('.snn-learn-chapter-dots-container');
            const chapterSectionsContainer = playerWrapper.querySelector('.snn-learn-chapter-sections-container');
            const progressTooltip         = playerWrapper.querySelector('.snn-learn-progress-tooltip');
            const fullscreenIcon          = playerWrapper.querySelector('.snn-learn-fullscreen-icon');
            const fullscreenExitIcon      = playerWrapper.querySelector('.snn-learn-fullscreen-exit-icon');
            const progressContainer       = playerWrapper.querySelector('.snn-learn-progress-container');
            const ccBtn                   = playerWrapper.querySelector('.snn-learn-cc-btn');
            const ccMenu                  = playerWrapper.querySelector('.snn-learn-cc-menu');
            const ccMenuItems             = playerWrapper.querySelectorAll('.snn-learn-cc-menu-item');
            const ccSettingsBtn           = playerWrapper.querySelector('.snn-learn-cc-settings-btn');
            const ccSettingsPanel         = playerWrapper.querySelector('.snn-learn-cc-settings-panel');
            const ccLangList              = playerWrapper.querySelector('.snn-learn-cc-lang-list');
            const ccBackBtn               = playerWrapper.querySelector('.snn-learn-cc-back-btn');
            const ccFontSizeInput         = playerWrapper.querySelector('.snn-learn-cc-font-size');
            const ccFontSizeValue         = playerWrapper.querySelector('.snn-learn-cc-font-size-value');
            const ccTextColorInput        = playerWrapper.querySelector('.snn-learn-cc-text-color');
            const ccBgColorInput          = playerWrapper.querySelector('.snn-learn-cc-bg-color');
            const ccBgOpacityInput        = playerWrapper.querySelector('.snn-learn-cc-bg-opacity');
            const ccBgOpacityValue        = playerWrapper.querySelector('.snn-learn-cc-bg-opacity-value');
            const settingsBtn             = playerWrapper.querySelector('.snn-learn-settings-btn');
            const settingsMenu            = playerWrapper.querySelector('.snn-learn-settings-menu');
            const speedOptions            = playerWrapper.querySelectorAll('.snn-learn-speed-option');
            ...
            const updateFullscreenIcons = () => {
                ...
                fullscreenIcon?.classList.toggle('snn-learn-hidden', isFullscreen);
                fullscreenExitIcon?.classList.toggle('snn-learn-hidden', !isFullscreen);
            };
            ...
            const updateChapterSectionsFill = () => {
                ...
                chapterSections.forEach((section) => {
                    const sectionFill = section.element.querySelector('.snn-learn-chapter-section-fill');
            ...
            const hideControls = () => {
                ...
                videoContainer?.classList.add('snn-learn-controls-hidden');
                videoContainer?.classList.remove('snn-learn-controls-visible');
            };

            const showControls = () => {
                videoContainer?.classList.remove('snn-learn-controls-hidden');
                videoContainer?.classList.add('snn-learn-controls-visible');
            ...
            const generateChapterSections = () => {
                ...
                if (sections.length === 0) {
                    ...
                    defaultSection.className = 'snn-learn-chapter-section';
                    defaultSection.style.width = '100%';
                    defaultSection.innerHTML = `
                        <div class="snn-learn-chapter-section-bg"></div>
                        <div class="snn-learn-chapter-section-fill"></div>
                    `;
                ...
                sections.forEach((section) => {
                    ...
                    sectionDiv.className = 'snn-learn-chapter-section';
            ...
            const generateChapters = () => {
                ...
                sections.forEach((section, index) => {
                    ...
                    dot.className = 'snn-learn-chapter-dot';
            ...
            const loadSubtitleSettings = () => {
                const settings = {
                    fontSize: localStorage.getItem('snn-learn-cc-font-size') || '20',
                    textColor: localStorage.getItem('snn-learn-cc-text-color') || '#ffffff',
                    bgColor: localStorage.getItem('snn-learn-cc-bg-color') || '#000000',
                    bgOpacity: localStorage.getItem('snn-learn-cc-bg-opacity') || '80'
                };
                return settings;
            };
            ...
            const loadSubtitleLanguagePreference = () => {
                return localStorage.getItem('snn-learn-cc-preferred-language');
            };

            const saveSubtitleLanguagePreference = (label) => {
                if (label === null || label === 'off') {
                    localStorage.setItem('snn-learn-cc-preferred-language', 'off');
                } else {
                    localStorage.setItem('snn-learn-cc-preferred-language', label);
                }
            };
                ...
                for (let i = 0; i < video.textTracks.length; i++) {
                    ...
                    if (track.label === preferredLanguage) {
                        ...
                        ccMenuItems.forEach(menuItem => {
                            if (menuItem.classList.contains('snn-learn-cc-settings-btn') || menuItem.classList.contains('snn-learn-cc-back-btn')) {
                                return;
                            }

                            const trackIndex = parseInt(menuItem.dataset.track);
                            if (trackIndex === i) {
                                menuItem.classList.add('snn-learn-active');
                                ...
                                menuItem.classList.remove('snn-learn-active');
                                const existingCheck = menuItem.querySelector('svg');
                                if (existingCheck) {
            ...
            const loadPlaybackSpeed = () => {
                return parseFloat(localStorage.getItem('snn-learn-playback-speed')) || 1.0;
            };

            const savePlaybackSpeed = (speed) => {
                localStorage.setItem('snn-learn-playback-speed', speed);
            };

            // Load volume from localStorage
            const loadVolume = () => {
                const savedVolume = localStorage.getItem('snn-learn-volume');
                const savedMuted = localStorage.getItem('snn-learn-muted');
                return {
            ...
            const saveVolume = (volume, muted) => {
                localStorage.setItem('snn-learn-volume', volume);
                localStorage.setItem('snn-learn-muted', muted);
            };

            const applySubtitleStyles = (settings) => {
                const styleId = 'snn-learn-subtitle-styles-' + '<?php echo esc_js($root_id); ?>';
            ...
            if (CONFIG.HAS_SUBTITLES && ccSettingsPanel) {
                ...
                ccFontSizeInput?.addEventListener('input', (e) => {
                    ...
                    saveSubtitleSetting('snn-learn-cc-font-size', value);
                ...
                ccTextColorInput?.addEventListener('input', (e) => {
                    saveSubtitleSetting('snn-learn-cc-text-color', e.target.value);
                    const currentSettings = loadSubtitleSettings();
                    applySubtitleStyles(currentSettings);
                });
                ...
                ccBgColorInput?.addEventListener('input', (e) => {
                    saveSubtitleSetting('snn-learn-cc-bg-color', e.target.value);
                    const currentSettings = loadSubtitleSettings();
                    applySubtitleStyles(currentSettings);
                });
                ...
                ccBgOpacityInput?.addEventListener('input', (e) => {
                    ...
                    saveSubtitleSetting('snn-learn-cc-bg-opacity', value);
                    const currentSettings = loadSubtitleSettings();
                    applySubtitleStyles(currentSettings);
                });
                ...
                ccSettingsBtn?.addEventListener('click', (e) => {
                    e.stopPropagation();
                    ccLangList?.classList.add('snn-learn-hidden');
                    ccSettingsPanel?.classList.add('snn-learn-show');
                    ccBackBtn?.classList.add('snn-learn-show');
                });
                
                // Back button click
                ccBackBtn?.addEventListener('click', (e) => {
                    e.stopPropagation();
                    ccLangList?.classList.remove('snn-learn-hidden');
                    ccSettingsPanel?.classList.remove('snn-learn-show');
                    ccBackBtn?.classList.remove('snn-learn-show');
                });
            }
            ...
            if (settingsBtn && settingsMenu && speedOptions) {
                ...
                speedOptions.forEach(option => {
                    ...
                    if (optionSpeed === closestSpeed) {
                        option.classList.add('snn-learn-active');
                        const checkmark = document.createElement('div');
                        checkmark.innerHTML = ICONS.check;
                ...
                settingsBtn.addEventListener('click', (e) => {
                    e.stopPropagation();
                    settingsMenu.classList.toggle('snn-learn-show');
                    // Close CC menu if open
                    if (ccMenu) ccMenu.classList.remove('snn-learn-show');
                });
                ...
                speedOptions.forEach(option => {
                    option.addEventListener('click', (e) => {
                        ...
                        speedOptions.forEach(opt => {
                            opt.classList.remove('snn-learn-active');
                        ...
                        // Close menu
                        settingsMenu.classList.remove('snn-learn-show');
                    });
                });
            ...
            if (CONFIG.HAS_SUBTITLES && ccBtn && ccMenu) {
                ccBtn.addEventListener('click', (e) => {
                    e.stopPropagation();
                    ccMenu.classList.toggle('snn-learn-show');
                    // Close settings menu if open
                    if (settingsMenu) settingsMenu.classList.remove('snn-learn-show');
                });
                ...
                ccMenuItems.forEach(item => {
                    ...
                    if (item.classList.contains('snn-learn-cc-settings-btn') || item.classList.contains('snn-learn-cc-back-btn')) {
                        return;
                    }
                    ...
                    item.addEventListener('click', (e) => {
                        ...
                        if (trackIndex >= 0 && trackIndex < video.textTracks.length) {
                            ...
                            item.classList.add('snn-learn-active');
                            // Add checkmark
                            const checkmark = document.createElement('div');
                            checkmark.innerHTML = ICONS.check;
                        ...
                        ccMenu.classList.remove('snn-learn-show');
                    });
                });
            ...
            // Fire custom event when video starts playing
            video.addEventListener('play', () => {
                if (!hasVideoStarted) {
                    hasVideoStarted = true;
                    const event = new CustomEvent('snn_learn_video_started', {
                        detail: {
            ...
            video.addEventListener('ended', () => {
                const event = new CustomEvent('snn_learn_video_completed', {
                    detail: {
                        url: window.location.href,
                        videoUrl: video.currentSrc,
                        elementId: '<?php echo esc_js($root_id); ?>',
            ...
            if (!window._snnLearnViewportPlayers) {
                window._snnLearnViewportPlayers = new Set();
            }
            ...
            const observerCallback = (entries) => {
                entries.forEach(entry => {
                    ...
                    if (entry.intersectionRatio >= 0.5) {
                        ...
                        window._snnLearnViewportPlayers.forEach(otherVideo => {
            ...
            if (CONFIG.PLAY_ON_VIEWPORT) {
                window._snnLearnViewportPlayers.add(video);
            }
