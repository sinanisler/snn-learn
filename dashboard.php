...
function snn_learn_dashboard_page() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function snnExportCSV(btn, url, nonce) {
