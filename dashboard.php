...
function snn_learn_dashboard_page() {
    ...
    $completion_rate      = $total_lessons_all ? round( $completed_lessons_all / $total_lessons_all * 100, 1 ) : 0;
    ...
    <div class="p-6 max-w-screen-xl">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div class="snn-kpi-card bg-white rounded-xl shadow-sm p-5 ">
                ...
                <p class="snn-kpi-desc text-xs text-gray-400 mt-1"><?= number_format( $completed_lessons_all ) ?> / <?= number_format( $total_lessons_all ) ?> lessons &amp; chapters</p>
            </div>
