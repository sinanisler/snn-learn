...
add_shortcode( 'snn_learn_mark_completed', function ( $atts ) {
    ...
    // Always render as not-done â€” JS fetches real state to defeat HTML page cache
    $label    = $atts['label'];
    $disabled = '';
    $done_cls = '';
    ...
    // Check completion status fresh on load â€” bypasses cached HTML
    (function() {
...
function snn_learn_shortcodes_page() {
    $shortcodes = [
        ...
        [
            ...
            'description' => 'Outputs a plain number (0â€“100) representing the current user\'s completion percentage for the grandparent course of the current post. Safe to use inside any loop or builder element. Supports an optional output attribute: use output="bool" to receive the string "true" or "false" instead of a number â€” useful for conditional visibility logic in page builders such as Elementor or Bricks.',
            'attributes'  => [
                'course_id' => 'Optional. Manually specify a course ID. Defaults to the grandparent course of the current post.',
                'output'    => 'Optional. Set to "bool" to return "true" or "false" instead of 0â€“100. Returns "true" when progress is greater than 1%.',
            ],
        ],
        [
            'tag'         => '[snn_learn_course_chapter_lesson_list]',
            'description' => 'Renders the full chapter â†’ lesson navigation list for the current course. Chapters and lessons share one post type â€” chapters are direct children of the course (no link), lessons are children of chapters (linked). Ordered by menu_order. Completed lessons show a âœ“ mark. The link of the lesson currently being viewed receives the CSS class snn-lesson-current, making it easy to style the active item in your sidebar navigation.',
            'attributes'  => [
        ...
        [
            ...
            'attributes'  => [
                ...
                'completed_label' => 'Text shown after completion. Default: "âœ“ Completed".',
            ],
        ],
        [
            ...
            'attributes'  => [
                ...
                'confirmed_label' => 'Text shown after deletion. Default: "âœ“ Your data has been deleted.".',
            ],
        ],
        [
            ...
            <table style="border-collapse:collapse;font-size:12px;width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding:6px 0;color:#4b5563">JSON: <code>{ post_id: INT, complete: BOOL }</code> â€” Nonce via X-WP-Nonce header.</td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding:6px 0;color:#4b5563">Query: <code>?course_id=INT</code> â€” Returns <code>{ progress: 0-100 }</code>.</td>
                    </tr>
                    <tr>
